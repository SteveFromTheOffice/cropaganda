...
|-----------|----------|----------|
| Architecture, stack decisions, trade-offs | Rusty | Tech stack choice, project structure, WPF layout |
| UI, crop interface, controls | Linus | Crop overlay, drag-drop, zoom/pan, keyboard shortcuts |
| Image processing, file I/O | Livingston | Loading images, crop math, 4:5 calculations, writing output |
| Code review | Rusty | Review PRs, check quality, suggest improvements |
| Testing | Basher | Write tests, find edge cases (corrupt files, odd formats, huge images) |
